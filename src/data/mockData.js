...
export const days = [
  {
    ...
    resources: [
      { label: "Watch walkthrough", url: "https://youtube.com" },
      { label: "MDN CSS Grid docs", url: "https://developer.mozilla.org" },
      { label: "Starter code", url: "https://github.com" },
    ],
    status: "done",
  },
  {
    ...
    resources: [
      { label: "Watch walkthrough", url: "https://youtube.com" },
      { label: "React docs: useEffect", url: "https://react.dev" },
      { label: "Starter code", url: "https://github.com" },
    ],
    status: "done",
  },
  {
    ...
    resources: [
      ...
      { label: "Starter code repo", url: "https://github.com" },
    ],
    status: "today",
  },
  {
    ...
    resources: [
      { label: "Watch walkthrough", url: "https://youtube.com" },
      { label: "DnD guide", url: "https://developer.mozilla.org" },
      { label: "Starter code", url: "https://github.com" },
    ],
    status: "locked",
  },
